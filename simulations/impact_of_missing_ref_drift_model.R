...
## is performed using an incomplete reference panel (drift model)##
...
Sim_deconv_missing_ref_drift <- function(M, Pi_s, Fst, N_s, N1_r){
...
simulations <- run_simulations(Design, Sim_deconv_missing_ref_drift)
