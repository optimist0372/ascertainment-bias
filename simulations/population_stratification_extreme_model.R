...
## on theta1 and theta2 using extreme model ##
...
Sim_PopStrat_extreme <- function(M,Pi_s,Pi_r,  Fst, N_s, N_r, C=0.01){
...
simulations <- run_simulations(Design, Sim_PopStrat_extreme)
