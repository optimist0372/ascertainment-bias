...
## in the reference following deconvolution (drift model) ##
...
Sim_deconc_attenuation_bias_drift <- function(M, Pi_s, Fst, N_s, N1_r, N2_r){
...
simulations <- do.call("rbind", lapply(1:nrow(Design), function(i) {
  ...
  Sim_deconc_attenuation_bias_drift(M=Design[i, "M"],Fst=Design[i, "Fst"], Pi_s=Design[i, "Pi_s"],  
